...
def main():
    ...
    global tokenizer, config, MODEL,MODEL_TYPE
...
def generarGrafico(metrics):
    ...
    for name, valores in metricas2.items():  # Iterar sobre las claves y valores del diccionario
        plt.plot(range(len(valores)), valores, label=name)
